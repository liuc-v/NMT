...
if __name__ == "__main__":
    ...
    valid_en_data, valid_zh_data = load_data2("../cmn_valid.txt.txt", 100000000)
    ...
    valid_dataloader = DataLoader(valid_dataset, shuffle=False, collate_fn=dataset.batch_data_process)
    ...
    #         output = model(en_index, zh_index, 0.0)
